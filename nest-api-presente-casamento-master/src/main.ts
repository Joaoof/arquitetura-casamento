...
async function bootstrap() {
  ...
  app.enableCors({
    origin: ['https://vemprocasorio.netlify.app', 'http://localhost:5173', 'https://casamento-jn43.vercel.app/luis-vitoria','https://casamento-jn43.vercel.app', 'https://casaivem.vercel.app/luis-natiele'], // ou use '*' para permitir qualquer origem (apenas em dev!)
